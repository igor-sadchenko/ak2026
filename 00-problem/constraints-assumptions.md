...
| A10 | About 55 enclosures need 3 to 5 sensors each, so 200 to 275 welfare sensors plus about 600 devices in total including gates, counters and cameras. | Device count drives NFR-SCALE-2 sizing and CapEx only. A doubling stays inside a single managed broker tier. |
